...
router.get('/2016/:kierrosId', function(req, res) {
  ...
  var sql = 'SELECT m.* FROM sarjataulukkodata m LEFT JOIN sarjataulukkodata b ON m.team_id = b.team_id AND m.kierros_id < b.kierros_id AND b.kierros_id < '+connection.escape(kierros)+' AND b.season_id = 1 WHERE b.kierros_id IS NULL AND m.kierros_id < '+connection.escape(kierros)+' m.season_id = 1 ORDER BY m.team_id';
