...
router.get('/', function(req, res) {
  ...
  db.query('SELECT m.* FROM sarjataulukkodata m LEFT JOIN sarjataulukkodata b ON m.team_id = b.team_id AND m.kierros_id < b.kierros_id AND b.season_id = 1 WHERE b.kierros_id IS NULL AND m.season_id = 1 ORDER BY (m.voitot*3+m.tasan) DESC, (m.tdf-m.tda) DESC, (m.casf-m.casa) DESC', function(err, rows, fields) {
